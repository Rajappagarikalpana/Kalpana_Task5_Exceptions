...
public class Simple_and_Compound_Interest implements Presented {
	private static final Logger LOGGER=LogManager.getLogger(Simple_and_Compound_Interest.class);
	public static void main(String[] args) {
		Simple_and_Compound_Interest object=new Simple_and_Compound_Interest();
